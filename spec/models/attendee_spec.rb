...
RSpec.describe Attendee, type: :model do
  ...
  before(:each) do
    @peninsula = courses(:peninsula)
    @outing = Outing.new(course_id: @peninsula.id, name: "2019 Peninsula", start_date: Date.strptime("05/19/2018", '%m/%d/%Y'), end_date: Date.strptime("05/22/2018", '%m/%d/%Y'))
  end
